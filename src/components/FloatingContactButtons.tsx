    ...
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-4">
      ...
      <a
        ...
        className={`
          ...
          h-14 rounded-l-2xl pl-4 pr-5
          bg-gradient-to-r from-[#25D366] to-[#128C7E]
          text-white font-medium
          transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]
          shadow-[0_8px_32px_rgba(37,211,102,0.4)]
          hover:shadow-[0_12px_48px_rgba(37,211,102,0.6)]
          ${hoveredButton === 'whatsapp' ? 'translate-x-0 w-40' : 'translate-x-[calc(100%-3.5rem)] w-40'}
        `}
        onMouseEnter={() => setHoveredButton('whatsapp')}
        onMouseLeave={() => setHoveredButton(null)}
        onTouchStart={() => setHoveredButton(hoveredButton === 'whatsapp' ? null : 'whatsapp')}
        aria-label="Contact on WhatsApp"
      >
        <div className="flex-shrink-0 drop-shadow-[0_0_12px_rgba(255,255,255,0.6)]">
          <WhatsAppIcon />
        </div>
      ...
      <a
        ...
        className={`
          ...
          transition-all duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]
          shadow-[0_8px_32px_hsl(var(--secondary)/0.4)]
          hover:shadow-[0_12px_48px_hsl(var(--secondary)/0.6)]
          ${hoveredButton === 'phone' ? 'translate-x-0 w-40' : 'translate-x-[calc(100%-3.5rem)] w-40'}
        `}
        onMouseEnter={() => setHoveredButton('phone')}
        onMouseLeave={() => setHoveredButton(null)}
        onTouchStart={() => setHoveredButton(hoveredButton === 'phone' ? null : 'phone')}
        aria-label="Call us"
      >
        <div className="flex-shrink-0 drop-shadow-[0_0_12px_rgba(255,255,255,0.6)]">
          <PhoneIcon />
